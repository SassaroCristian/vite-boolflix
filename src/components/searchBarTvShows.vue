<template>
    <form class="rounded-lg w-11/12 m-auto" @submit.prevent="search">
        ...
        <div class="relative">
            ...
            <input v-model="searchTermTvShows" @input="search" type="search" id="default-search"
...
export default {
    ...
    methods: {
        search() {
            this.$emit('search', this.searchTermTvShows);
        },
    },
};
</script>
